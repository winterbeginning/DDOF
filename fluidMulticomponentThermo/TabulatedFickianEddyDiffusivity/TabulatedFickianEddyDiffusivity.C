...
template <class TurbulenceThermophysicalTransportModel>
bool TabulatedFickianEddyDiffusivity<
    TurbulenceThermophysicalTransportModel>::read()
{
    if (TabulatedFickian<unityLewisEddyDiffusivity<
            TurbulenceThermophysicalTransportModel>>::read())
    {
    ...
    const volScalarField &Yi) const
{
    return volScalarField::New(
        "DEff",
        TabulatedFickian<unityLewisEddyDiffusivity<
                TurbulenceThermophysicalTransportModel>>::DEff(Yi) +
...
{
    return TabulatedFickian<unityLewisEddyDiffusivity<
               TurbulenceThermophysicalTransportModel>>::DEff(Yi, patchi) +
