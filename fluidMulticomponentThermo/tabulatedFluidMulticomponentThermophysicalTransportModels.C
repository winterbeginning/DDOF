...
makeRASLESThermophysicalTransportModel(RAS, TabulatedFickianEddyDiffusivity);
...
#include "TabulatedFickianEddyDiffusivity.H"
makeRASLESThermophysicalTransportModel(LES, TabulatedFickianEddyDiffusivity);

#include "FickianEddyDiffusivity.H"
makeRASLESThermophysicalTransportModel(LES, FickianEddyDiffusivity);
